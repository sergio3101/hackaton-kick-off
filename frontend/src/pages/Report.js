...
import { VERDICT_LABEL_RU } from "../api/types";
const VERDICT_PILL = {
    correct: "pill--accent",
    partial: "pill--warn",
                    ...
                    { k: "coding", l: `Кодинг · ${codingItems.length}` },
                        ...
                        cursor: "pointer",
                            ...
                            gap: 10,
                                ...
                                gap: 12,
                                marginBottom: 12,
                            }, children: [_jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { className: "mono upper", style: { color: "var(--accent)", marginBottom: 4 }, children: item.topic }), _jsx("div", { style: { fontWeight: 500 }, children: item.prompt_text })] }), item.verdict && (_jsx("span", { className: `pill ${VERDICT_PILL[item.verdict]}`, children: VERDICT_LABEL_RU[item.verdict] }))] }), _jsx(ReportBlock, { label: "\u041E\u0442\u0432\u0435\u0442 \u043A\u0430\u043D\u0434\u0438\u0434\u0430\u0442\u0430", children: item.answer_text || "(пусто)" }), item.rationale && (_jsx(ReportBlock, { label: "\u041E\u0431\u043E\u0441\u043D\u043E\u0432\u0430\u043D\u0438\u0435", children: item.rationale })), item.explanation && (_jsx(ReportBlock, { label: "\u0427\u0442\u043E \u0443\u043F\u0443\u0449\u0435\u043D\u043E", variant: "warn", children: item.explanation })), item.expected_answer && (_jsx(ReportBlock, { label: "\u042D\u0442\u0430\u043B\u043E\u043D\u043D\u044B\u0439 \u043E\u0442\u0432\u0435\u0442", variant: "accent", children: item.expected_answer }))] }, item.id)))) })), tab === "coding" && (_jsx("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: codingItems.length === 0 ? (_jsx("div", { className: "card", style: { color: "var(--ink-3)", textAlign: "center" }, children: "\u041A\u043E\u0434\u0438\u043D\u0433-\u0437\u0430\u0434\u0430\u0447 \u0432 \u0441\u0435\u0441\u0441\u0438\u0438 \u043D\u0435\u0442." })) : (codingItems.map((item) => (_jsxs("div", { className: "card", children: [_jsxs("div", { style: {
                                display: "flex",
                                justifyContent: "space-between",
                                gap: 12,
                                marginBottom: 12,
                                    ...
                                    }, children: [item.verdict && (_jsx("span", { className: `pill ${VERDICT_PILL[item.verdict]}`, children: VERDICT_LABEL_RU[item.verdict] })), isAdmin && (item.paste_chars ?? 0) > 0 && (_jsx(PasteBadge, { pasteChars: item.paste_chars ?? 0, codeLen: item.answer_text?.length ?? 0 }))] })] }), item.answer_text && (_jsx("pre", { style: {
